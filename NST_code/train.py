...
from utils.utils import ImageFolderDataset,get_transforms,adaptive_instance_normalization,calc_mean_std
...
def parse_arguments():
    ...
    parse.add_argument("--content_dir",type=str,default=r"C:\Users\91749\Prime Classes\Major Projects\Natural Style Transfer\content_data",
                       help="Location of content dataset")
    parse.add_argument("--style_dir",type=str,default=r"C:\Users\91749\Prime Classes\Major Projects\Natural Style Transfer\style_data",
                       help="Location of style dataset")
    parse.add_argument("--vgg",type=str,default=r"C:\Users\91749\Prime Classes\Major Projects\Natural Style Transfer\vgg_normalised.pth",
                       help="Location of pre-trained VGG")
    parse.add_argument("--experiment",type=str,default="experiment1",
                       help="Name of experiment")
    parse.add_argument("--final_size",type=int,default=256,
                       help="Size of final image")
    parse.add_argument("--content_size",type=int,default=512,
                        help="Size of content image")
    parse.add_argument("--style_size",type=int,default=512,
                       help="Size of style image")
    parse.add_argument("--crop",action='store_true',default=True,
                       help="Crop Image")
    parse.add_argument("--batch_size",type=int,default=4,
                       help="Batch Size")
    parse.add_argument("--lr",type=float,default=1e-4,
                       help="Learning Rate")
    parse.add_argument("--lr_decay",type=float,default=5e-5,
                       help="Learning rate decay")
    parse.add_argument("--epochs",type=int,default=1,
                       help="Number Of epochs")
    parse.add_argument("--content_weight",type=int,default=1.0,
                       help="Content Weights")
    parse.add_argument("--style_weight",type=int,default=10,
                       help="Style Weights")
    parse.add_argument("--log_interval",type=int,default=1,
                       help="Log Intervals")
    parse.add_argument("--save_interval",type=int,default=2,
                       help="Save Interval")
    parse.add_argument("--resume",action='store_true',default=False,
                       help="Resume Training")
    parse.add_argument("--decoder_path",type=str,default=None,
                       help="Path to decoder checkpoint")
    parse.add_argument("--optimizer_path",type=str,default=None,
...
def main():
    ...
    print("Numebr of batches in style dataset",len(style_dataloader))
